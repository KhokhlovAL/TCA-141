...
bool hasTwoPairsWithSameSign(int** arr, const int rows, const int cols);
void printIndicesGreaterThanPrevious(int** arr, const int rows, const int cols);
...
int main()
{
    ...
    replaceMinWithAverage(int** arr,size_t rows,size_t cols);
